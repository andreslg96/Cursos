package com.alg.springboot.error.app.services;
...
import com.alg.springboot.error.app.models.domain.Usuario;
...
public class UsuarioServiceImpl implements UsuarioService {
	...
	public UsuarioServiceImpl() {
		...
		this.lista.add(new Usuario(1, "Andrés", "L"));
		...
		this.lista.add(new Usuario(5, "Pato", "Gonzáles"));
