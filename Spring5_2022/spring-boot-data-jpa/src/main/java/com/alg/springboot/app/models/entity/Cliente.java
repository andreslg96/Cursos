package com.alg.springboot.app.models.entity;
...
public class Cliente implements Serializable {
	...
	@Id // indicamos que es la llave
	@GeneratedValue(strategy = GenerationType.IDENTITY) // con que herramienta vamos a trabajar
	private Long id;
