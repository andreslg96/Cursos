...
public class DemoRestService {
	...
	@Operation(summary = "actualiza equipo", description="Actualiza la información un equipo existente",
			tags= {"DemoRestService"})
	...
	@Operation(summary="Añadir jugador", description = "Añadir un jugador existente a un equipo",
			tags= {"DemoRestService"})
